// Uncomment the line "LibraryProperties->SetLibraryName(...)" and replace "alexnet_tools" with desired SystemVue model library name.
...
// 	pLibraryProperties->SetLibraryName( "alexnet_tools" );
